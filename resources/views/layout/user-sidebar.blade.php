        ...
        <ul>
            ...
            <li class="nav-item nav-item-has-children">
                ...
                <ul id="ddmenu_2" class="collapse dropdown-nav">
                    <li>
                        <a href="{{ route('user.mydeposite') }}"> History </a>
                    </li>
                    <li>
                        <a href="{{ route('user.requestdeposite') }}"> Make Request </a>
                    </li>
                    <li>
                        <a href="{{ route('user.pendingdeposite') }}"> Request History </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item nav-item-has-children">
                ...
                <ul id="meals" class="collapse dropdown-nav">
                    <li>
                        <a href="{{ route('user.mymeal') }}"> History </a>
                    </li>
                    <li>
                        <a href="{{ route('user.requestmeal') }}"> Make Request </a>
                    </li>
                    <li>
                        <a href="{{ route('user.pendingmeal') }}"> Pending Meals </a>
                    </li>
                </ul>
            </li>
            ...
            {{-- My Cost History --}}
            <li class="nav-item">
                <a href="{{ route('user.mycost') }}">
                    <i class="lni lni-consulting" style="margin-right: 10px;"></i>
                    <span class="text">Cost History</span>
                </a>
            </li>
            ...
            <li class="nav-item nav-item-has-children">
                ...
                <ul id="bazar" class="collapse dropdown-nav">
                    <li>
                        <a href="{{ route('user.mybazar') }}"> History </a>
                    </li>
                    <li>
                        <a href="{{ route('user.requestbazar') }}"> Make Request </a>
                    </li>
                    <li>
                        <a href="{{ route('user.pendingbazar') }}"> Pending Bazars </a>
                    </li>
                </ul>
            </li>
