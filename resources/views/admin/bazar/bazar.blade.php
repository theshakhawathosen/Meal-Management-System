                ...
                <div class="col-lg-12">
                    <div class="card-style settings-card-1 mb-30">
                        <div class="title mb-30 d-flex justify-content-between align-items-center">
                            <h4>Bazar List</h4>
                            <div>
                                <a href="{{ route('admin.addbazar') }}" class="btn py-2 p-3 btn-sm btn-primary"><i
                                        class="lni lni-plus"></i></a>
                                <a href="{{ route('admin.pendingbazar') }}" class="btn py-2 p-3 btn-sm btn-danger "><i class="lni lni-hourglass"></i></a>
                            </div>
                        </div>
                                        ...
                                        <tr id="trrow{{ $bazar->id }}">
                                            ...
                                            <td>
                                                <div class="action">
                                                    ...
                                                    <a href="{{ route('admin.editbazar',$bazar->id) }}"><i
